"""
File has the mappings of user input choices on the front end to the fields in our database. 
Allows user input to be made into Django form.
Built in collaboration with Jack Anteby.
"""
