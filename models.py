"""
Database has star schema, with each row in every table pointing to a single neighborhood in the Neighborhood table.
Allows for fast and flexible querying, and adjustments to the database.
Built in collaboration with other members of project.
"""
